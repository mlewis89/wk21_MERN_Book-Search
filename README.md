...
# Bootcamp Challenge Week Twenty One - MERN Challenge: Book Search Engine
[![License](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)


## Description

The purpose of this application is to test my knowledge of a mern and and Graphql. 

This application was a refactoring exercise to change an existing application running a RESTfull API to a graphql API.  

In this project i learnt alot about the differences between a RESTful API and a graphql API, while ensuring no change to user expirence.
